  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          {steps.map((s, index) => {
            ...
            return (
              <div key={s.id} className="flex items-center">
                ...
                {index < steps.length - 1 && <div className={`w-32 h-1 mx-4 transition-all duration-700 ${isCompleted ? "bg-green-500" : "bg-gray-300"}`} />}
              </div>
            );
          })}
        </div>

        {/* Kotak Analisis (cuma tab + input) */}
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-10 md:p-16 transition-all duration-700 max-w-7xl mx-auto">
          {step === "upload" && (
            <div className="animate-fadeIn">
              <h2 className="text-3xl font-bold text-center mb-12 text-indigo-700">Pilih Cara Input Tulisan Tangan</h2>

              {/* Tab pemilih metode input */}
                ...
                {inputTabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-6 py-3 font-semibold transition-all border-b-2 -mb-px ${active ? "border-indigo-600 text-indigo-600" : "border-transparent text-gray-400 hover:text-indigo-500"}`}
                    >
              ...
              <div className="max-w-3xl mx-auto">
                ...
                {inputMethod === "kamera" && <AssistedCamera onCapture={(dataUrl) => handleUploadComplete(dataUrl)} />}
              </div>
            </div>
          )}
        ...
        {/* ===== TIPS: kotak terpisah, di BAWAH kotak analisis ===== */}
        {step === "upload" && (
          <div className="mt-10 bg-white/80 backdrop-blur-md rounded-3xl shadow-xl p-8 md:p-10 animate-fadeIn">
            <div className="flex items-center justify-center gap-3 mb-8">
              <Lightbulb className="w-8 h-8 text-yellow-500" />
              <h3 className="text-2xl font-bold text-indigo-700 text-center">Tips Foto Tulisan Tangan Terbaik untuk Analisis Akurat</h3>
            </div>

            <div className="grid md:grid-cols-2 gap-8 mb-10 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="bg-green-100 rounded-2xl p-5 shadow-lg">
                  <img src="https://qph.cf2.quoracdn.net/main-qimg-9566da9f8272b4ba9de140d702d87da8-pjlq" alt="Contoh BAIK: tulisan jelas, pencahayaan merata" className="rounded-xl shadow-xl mx-auto max-h-56 object-contain" />
                </div>
            ...
            <ul className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
        ...
        {step === "upload" && (
          <div className="mt-10 bg-white/80 backdrop-blur-md rounded-3xl shadow-xl p-8 md:p-10 animate-fadeIn">
            <div className="flex items-center justify-center gap-3 mb-8">
              <Lightbulb className="w-8 h-8 text-yellow-500" />
              <h3 className="text-2xl font-bold text-indigo-700 text-center">Tips Menulis Langsung di Layar (Tablet/HP)</h3>
            </div>
