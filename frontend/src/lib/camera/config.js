...
export const DEFAULT_CONFIG = {
  ...
  blurMin: 500, // variansi Laplacian minimum agar tajam (naik = wajib lebih tajam)
  skewMaxDeg: 12, // kemiringan kertas maksimum (derajat)
  ...
  rotation: {
    maxAngleDeg: 12, // toleransi kemiringan sebelum memicu peringatan
