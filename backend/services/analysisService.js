...
const ENNEAGRAM_KNOWLEDGE_BASE = {
  "Tipe 1": {
    ...
    recommendations: ["Belajarlah untuk menerima ketidaksempurnaan, baik pada diri sendiri maupun orang lain.", "Luangkan waktu untuk relaksasi tanpa merasa bersalah.", "Sadarilah bahwa 'cukup baik' seringkali sudah memadai."],
  },
  "Tipe 2": {
    ...
    recommendations: ["Tetapkan batasan yang sehat, jangan selalu berkata 'ya'.", "Prioritaskan kebutuhan diri sendiri sebelum membantu orang lain.", "Sadari bahwa Anda layak dicintai tanpa harus selalu memberi."],
  },
  "Tipe 3": {
    ...
    recommendations: ["Luangkan waktu untuk istirahat, hindari burnout.", "Fokus pada kejujuran emosional, bukan hanya citra diri.", "Nilai diri Anda berdasarkan siapa Anda, bukan apa yang Anda capai."],
  },
  "Tipe 4": {
    ...
    recommendations: ["Bangun rutinitas positif untuk menstabilkan suasana hati.", "Hindari terlalu larut dalam kesedihan atau mengasihani diri sendiri.", "Fokus pada tindakan nyata daripada hanya berimajinasi."],
  },
  "Tipe 5": {
    ...
    recommendations: ["Cobalah untuk lebih terhubung secara emosional dengan orang lain.", "Jangan hanya mengamati kehidupan, berpartisipasilah di dalamnya.", "Berbagi pengetahuan bisa lebih memuaskan daripada menyimpannya sendiri."],
  },
  "Tipe 6": {
    ...
    recommendations: ["Percayalah pada insting dan kemampuan diri sendiri.", "Sadari kapan kewaspadaan berubah menjadi kecemasan berlebih.", "Fokus pada solusi, bukan skenario terburuk."],
  },
  "Tipe 7": {
    ...
    recommendations: ["Latihlah fokus dan selesaikan apa yang sudah dimulai.", "Belajarlah untuk diam dan menikmati ketenangan.", "Sadari bahwa kepuasan tidak selalu datang dari pengalaman baru."],
  },
  "Tipe 8": {
    ...
    recommendations: ["Gunakan kekuatan Anda untuk melindungi, bukan mengintimidasi.", "Izinkan diri Anda untuk menunjukkan sisi rentan (vulnerability).", "Dengarkan pendapat orang lain sebelum mengambil alih kendali."],
  },
  "Tipe 9": {
    ...
    recommendations: ["Beranilah menyuarakan pendapat dan kebutuhan Anda.", "Jangan menunda masalah demi kenyamanan sesaat.", "Sadarilah bahwa konflik terkadang diperlukan untuk pertumbuhan."],
  },
};
...
class AnalysisService {
  ...
  static async analyzeHandwriting(userId, imageData, analysisType) {
    ...
    try {
      ...
      analysis.recommendations = ["Manfaatkan kekuatan unik tipe kepribadian Anda.", "Perhatikan area pengembangan diri yang disarankan.", "Jaga keseimbangan emosi dan logika."];
  ...
  static async getStatistics() {
    ...
    const distribution = await Analysis.aggregate([{ $match: { status: "completed" } }, { $group: { _id: "$enneagramType", count: { $sum: 1 } } }]);
